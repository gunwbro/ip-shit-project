...
<body>
	...
	String equery = "SELECT * FROM webtoon where wtKey=" + wtKey;
	...
	<div class="wrap">
		...
		<div class="right">
			<div class="content">
				...
				<div class="body">
					<div class="blank"></div>
					<form action="updateWebtoon.jsp?id=<%=wtKey%>" method="POST"
						...
						<div class="bodyElem">
							...
							<input class="authorValue" type="text" name="author"
								value=<%=epr.getString("author")%>>
						</div>
						<div class="bodyElem">
							<div class="textBox">작가의 말 :</div>
							<textarea class="authorTextValue" cols="35" rows="10"
								name="authorText"><%=epr.getString("authorText")%></textarea>
						</div>
						<div class="bodyElem">
							<div class="textBox">줄거리 :</div>
							<textarea class="summaryValue" cols="35" rows="10" name="summary"><%=epr.getString("story")%></textarea>
						</div>
						<%
						}
						%>
